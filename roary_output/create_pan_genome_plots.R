...
theme(legend.justification=c(0,1), legend.position.inside=c(0,1), legend.position="inside")
suppressMessages(ggsave(filename="conserved_vs_total_genes.png", scale=1))
...
xlab("No. of genomes") +
ylab("No. of genes") + theme_bw(base_size = 16) +
theme(legend.justification=c(1,1), legend.position.inside=c(1,1), legend.position="inside")
suppressMessages(ggsave(filename="unique_vs_new_genes.png", scale=1))
